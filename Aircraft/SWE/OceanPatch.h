...
{
public:
	OceanPatch(int size, float patchSize, int windType = 8);
...
private:
	...
	//GLuint m_displacement_texture = 0;		// opengl texture
	
	//cudaGraphicsResource_t m_cuda_displacement_texture;// cuda opengl object


	//GLuint m_gradient_texture = 0;

	//cudaGraphicsResource_t m_cuda_gradient_texture;
